    ...
    >
        ...
        <v-card class="pr-2 mx-2">
            ...
            >
                ...
                <v-divider class="mx-2 mt-3" style="border-color: black;"></v-divider>
                </v-row>
                <v-row>       
                    <v-col
                    cols="12"
                    ...
                    >
                        ...
                        >
                            ...
                            <v-card>
                                ...
                                <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="blue darken-1" text @click="closeDeleteAnak">Cancel</v-btn>
                                <v-btn color="blue darken-1" text @click="deleteItemConfirmAnak">OK</v-btn>
                                <v-spacer></v-spacer>
                                </v-card-actions>
                            </v-card>
                            </v-dialog>
                    ...
                    >
                        ...
                        >
                            ...
                            <v-card>
                                ...
                                <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="blue darken-1" text @click="closeDeleteRiwayat">Cancel</v-btn>
                                <v-btn color="blue darken-1" text @click="deleteItemConfirmRiwayat">OK</v-btn>
                                <v-spacer></v-spacer>
                                </v-card-actions>
                            </v-card>
                            </v-dialog>
                ...
                <v-row class="mb-3 px-2">
                    ...
                    >
                        ...
                        >
                            ...
                            <v-card>
                                ...
                                <v-container>
                                    <v-row>
                                        ...
                                        >
                                            <v-text-field
                                            v-model="editedItemPengalaman.alasan_kepindahan"
                                            label="Alasan Pindah"
                                            ></v-text-field>
                                        </v-col>
                                    </v-row>
                            ...
                            <v-dialog v-model="dialogDeletePengalaman" max-width="500px">
                            <v-card>
                                <v-card-title class="text-h5">Are you sure you want to delete this item?</v-card-title>
                                <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="blue darken-1" text @click="closeDeletePengalaman">Cancel</v-btn>
                                <v-btn color="blue darken-1" text @click="deleteItemConfirmPengalaman">OK</v-btn>
                                <v-spacer></v-spacer>
                                </v-card-actions>
                            </v-card>
                            </v-dialog>
                        ...
                        <v-icon
                            small
                            @click="deleteItemPengalaman(item)"
                        >
                            mdi-delete
                        </v-icon>
                        </template>
            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn dark color="#25695c" @click="saveItemConfirm">
                  ...
                  <v-icon  v-if="load == false" left> mdi-checkbox-marked-circle-outline </v-icon>
        ...
        <!-- Modal Verifikasi Cancel -->
          <v-dialog v-model="dialogVerifikasiCancel" max-width="500px">
            <v-card>
              <v-card-title class="headline"
                >Are you sure to cancel?</v-card-title
              >
              <v-card-actions>
                <v-spacer></v-spacer>
  ...
  methods: {
    ...
    saveemp(){
        ...
        if (this.$refs.form.validate() != true){
            ...
            this.detailEmp.listRiwayatPekerjaan = JSON.stringify(this.itemlistriwayatkerja);
            this.detailEmp.listPengalamanKerja = JSON.stringify(this.itemlistpengalamankerja);
    ...
    saveAnak () {
        if (this.editedIndexAnak > -1) {
          Object.assign(this.itemlistanak[this.editedIndexAnak], this.editedItemAnak)
        } else {
    ...
    saveRiwayat () {
        if (this.editedIndexRiwayat > -1) {
          Object.assign(this.itemlistriwayatkerja[this.editedIndexRiwayat], this.editedItemRiwayat)
        } else {
    ...
    closePengalaman () {
        ...
        this.$nextTick(() => {
          this.editedItemPengalaman = Object.assign({}, this.defaultItemPengalaman)
    ...
    savePengalaman () {
        if (this.editedIndexPengalaman > -1) {
          Object.assign(this.itemlistpengalamankerja[this.editedIndexPengalaman], this.editedItemPengalaman)
        } else {
        //   this.editedItemRiwayat.tgl = this.datepicker4;
